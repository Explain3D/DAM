...
class GaussianVAE(Module):
    ...
    def get_loss(self, x, label, writer=None, it=None, kl_weight=1.0):
        """
        Args:
        ...
        loss_recons = self.diffusion.get_loss(x, z, label)
    ...
    def sample(self, z, label, num_points, flexibility, truncate_std=None):
        """
        Args:
        ...
        samples = self.diffusion.sample(num_points, context=z, label=label, flexibility=flexibility)
        return samples
